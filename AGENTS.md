...
**Verz** - A Bible quiz and memory testing application where users challenge themselves to identify Bible verses and test their Scripture memorization.

### Branding & Messaging (Updated 2026-04-01)
**App Name: Verz** (not BiblePath)
**Default Theme: Dark mode**

All pages now consistently emphasize the **quiz/testing/challenge** nature of the app:
- **Landing Page**: "Test Your Bible Knowledge" - focuses on quizzes, challenges, and memory testing
- **Login Page**: "Continue Your Quiz Challenge" - highlights quiz streak and testing
- **Signup Page**: "Start Your Quiz Challenge" - emphasizes testing Bible knowledge
- **Dashboard**: "Solo Quiz" and "Multiplayer Quiz" - clear quiz/challenge language
- **PlaySoloPage**: "Ready to Quiz?" - Test your Bible knowledge with quick challenges
- **MultiplayerPage**: "Multiplayer Quiz" - Challenge friends in real-time Bible trivia
- **MultiplayerLobbyPage**: "Quiz Challenge Lobby" - Players waiting to start
- **LeaderboardPage**: Shows scores, points, and quiz completions
- **SoloQuizPage**: "Quiz Complete!" with score tracking
- **Key Terminology**: Uses "quiz", "challenge", "test", "compete", "memorize", "points" instead of "learn", "study", "explore", "verses explored", "sessions"

### Bible Verses Database (Updated 2026-04-01)
**160 Bible Verses** organized by 8 categories (20 verses each):
- Faith, Love, Wisdom, Healing, Marriage, Grace, Prosperity, Salvation

### Multiplayer Features (Updated 2026-04-01)
- **Session Creation**: Session is created in database immediately when code is generated (players can join right away without waiting for host to enter lobby)
- **Question Count Selection**: Host can select number of questions (5, 10, 15, or 20) in the lobby
- **Real-time Updates**: WebSocket channels for player joins, category selection, question count changes, and game start
